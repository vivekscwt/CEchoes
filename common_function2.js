...
async function userCompanyActivation(name,email) {
  var mailOptions = {
    from: process.env.MAIL_USER,
    //to: 'dev2.scwt@gmail.com',
    to: email,
                            ...
                            <table border="0" cellpadding="4" cellspacing="0" width="90%">
                              <tr>
                                <td colspan="2">
                                    ...
                                    <p style="font-size:15px; line-height:20px">Your account and company have been approved by the admin.</p>
                                    <p style="font-size:15px; line-height:20px">Now you can log in through your email and password in <a href="${process.env.MAIN_URL}">Cechoes.com</a>.</p>
                                <br><p style="font-size:15px; line-height:20px">Kind Regards,</p><p style="font-size:15px; line-height:20px">CEchoes Technology Team</p><br>
                                </td>
                              </tr>
                            </table>
                           </div>
