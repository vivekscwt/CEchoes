...
// `;
  ...
  try {
    ...
    `;
      ...
      console.log(`Email sent to ${userEmail} because days difference (${daysDifference}) is greater than ETA days (${eta_days})`);
      return results;
    }
  } catch (error) {
...
module.exports = {
  ...
  sendemailtolevelUsers,//COMPLAINTS
